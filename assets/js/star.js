...
(function ($) {
    ...
    $(document).ready(function () {
        $('.star-toggle').each(function () {
            const $btn = $(this);
            const starred = $btn.data('starred') === true || $btn.data('starred') === 'true';
            renderStar($btn, starred);
        });
    });
    ...
    $(document).on('click', '.star-toggle', function (e) {
        ...
        const isStarred = $btn.data('starred') === true || $btn.data('starred') === 'true';
